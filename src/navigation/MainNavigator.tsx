...
import { UserGalleryScreen }        from '../screens/Main/UserGalleryScreen';
...
import { JoinCommunityScreen }            from '../screens/Detail/JoinCommunityScreen';
  ...
  return (
    ...
    <ActiveVoiceProvider>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="UserGallery"    component={UserGalleryScreen}     options={{ animation: 'slide_from_right' }} />
        ...
        <Stack.Screen name="JoinCommunity"            component={JoinCommunityScreen}            options={{ animation: 'slide_from_bottom', headerShown: false, presentation: 'modal' }} />
