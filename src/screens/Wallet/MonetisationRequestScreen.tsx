...
const REQUIREMENTS = [
  ...
  { icon: 'check-circle', label: 'Respect des CGU FoliX' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={[s.legalNote, { backgroundColor: colors.backgroundSecondary }]}>
          ...
          <Text style={[s.legalText, { color: colors.textTertiary }]}>
            En soumettant cette demande, vous confirmez que votre contenu respecte les CGU FoliX et la législation en vigueur.
          </Text>
        </View>
