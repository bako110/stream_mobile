...
const BOOST_CATEGORIES: BoostCategory[] = [
  {
    id: 'followers',
    label: 'Abonnes',
    description: 'Augmente ta visibilite dans les suggestions de profil',
    icon: 'users',
    gradient: ['#7B3FF2', '#E0389A'],
    tiers: [
      { id: 'f1', label: 'Starter', quantity: '50 suggestions',  quantity_num: 50,   duration: '3 jours',  duration_days: 3,  coins: 200 },
      { id: 'f2', label: 'Growth',  quantity: '150 suggestions', quantity_num: 150,  duration: '7 jours',  duration_days: 7,  coins: 500,  popular: true },
      { id: 'f3', label: 'Viral',   quantity: '500 suggestions', quantity_num: 500,  duration: '14 jours', duration_days: 14, coins: 1500 },
      { id: 'f4', label: 'Mega',    quantity: '2K suggestions',  quantity_num: 2000, duration: '30 jours', duration_days: 30, coins: 5000 },
    ],
  },
  {
    id: 'profile_views',
    label: 'Vue profil',
    description: 'Ton profil apparait plus souvent dans les suggestions',
    icon: 'eye',
    gradient: ['#FF8C00', '#FF4500'],
    tiers: [
      { id: 'p1', label: 'Starter', quantity: '500 impressions',  quantity_num: 500,   duration: '2 jours',  duration_days: 2,  coins: 150 },
      { id: 'p2', label: 'Growth',  quantity: '2K impressions',   quantity_num: 2000,  duration: '5 jours',  duration_days: 5,  coins: 400,  popular: true },
      { id: 'p3', label: 'Viral',   quantity: '10K impressions',  quantity_num: 10000, duration: '10 jours', duration_days: 10, coins: 1200 },
      { id: 'p4', label: 'Mega',    quantity: '50K impressions',  quantity_num: 50000, duration: '21 jours', duration_days: 21, coins: 4000 },
    ],
  },
  {
    id: 'reel_views',
    label: 'Reels',
    description: 'Propulse ton reel dans le feed des autres utilisateurs',
    icon: 'play-circle',
    gradient: ['#E0389A', '#FF8C00'],
    contentType: 'reel',
    targetLabel: 'Choisir un reel',
    tiers: [
      { id: 'r1', label: 'Starter', quantity: '1K impressions',   quantity_num: 1000,   duration: '2 jours',  duration_days: 2,  coins: 200 },
      { id: 'r2', label: 'Growth',  quantity: '5K impressions',   quantity_num: 5000,   duration: '5 jours',  duration_days: 5,  coins: 600,  popular: true },
      { id: 'r3', label: 'Viral',   quantity: '25K impressions',  quantity_num: 25000,  duration: '10 jours', duration_days: 10, coins: 2000 },
      { id: 'r4', label: 'Mega',    quantity: '100K impressions', quantity_num: 100000, duration: '20 jours', duration_days: 20, coins: 6000 },
    ],
  },
  {
    id: 'post_reach',
    label: 'Posts',
    description: 'Ton post apparait plus haut dans les feeds',
    icon: 'file-text',
    gradient: ['#10B981', '#06B6D4'],
    contentType: 'post',
    targetLabel: 'Choisir un post',
    tiers: [
      { id: 'po1', label: 'Starter', quantity: '2K impressions',   quantity_num: 2000,   duration: '2 jours',  duration_days: 2,  coins: 200 },
      { id: 'po2', label: 'Growth',  quantity: '8K impressions',   quantity_num: 8000,   duration: '5 jours',  duration_days: 5,  coins: 550,  popular: true },
      { id: 'po3', label: 'Viral',   quantity: '30K impressions',  quantity_num: 30000,  duration: '10 jours', duration_days: 10, coins: 1600 },
      { id: 'po4', label: 'Mega',    quantity: '120K impressions', quantity_num: 120000, duration: '21 jours', duration_days: 21, coins: 5500 },
    ],
  },
  {
    id: 'event_reach',
    label: 'Evenements',
    description: 'Ton evenement gagne en visibilite dans le feed',
    icon: 'calendar',
    gradient: ['#F59E0B', '#EF4444'],
    contentType: 'event',
    targetLabel: 'Choisir un evenement',
    tiers: [
      { id: 'ev1', label: 'Starter', quantity: '500 impressions',  quantity_num: 500,   duration: '2 jours',  duration_days: 2,  coins: 300 },
      { id: 'ev2', label: 'Growth',  quantity: '2K impressions',   quantity_num: 2000,  duration: '5 jours',  duration_days: 5,  coins: 800,  popular: true },
      { id: 'ev3', label: 'Viral',   quantity: '8K impressions',   quantity_num: 8000,  duration: '10 jours', duration_days: 10, coins: 2200 },
      { id: 'ev4', label: 'Mega',    quantity: '30K impressions',  quantity_num: 30000, duration: '20 jours', duration_days: 20, coins: 7000 },
    ],
  },
  {
    id: 'concert_reach',
    label: 'Concerts',
    description: 'Ton concert apparait en tete de liste',
    icon: 'music',
    gradient: ['#8B5CF6', '#EC4899'],
    contentType: 'concert',
    targetLabel: 'Choisir un concert',
    tiers: [
      { id: 'co1', label: 'Starter', quantity: '300 impressions',  quantity_num: 300,   duration: '1 jour',   duration_days: 1,  coins: 400 },
      { id: 'co2', label: 'Growth',  quantity: '1.5K impressions', quantity_num: 1500,  duration: '3 jours',  duration_days: 3,  coins: 1000, popular: true },
      { id: 'co3', label: 'Viral',   quantity: '5K impressions',   quantity_num: 5000,  duration: '7 jours',  duration_days: 7,  coins: 2800 },
      { id: 'co4', label: 'Mega',    quantity: '20K impressions',  quantity_num: 20000, duration: '14 jours', duration_days: 14, coins: 8000 },
    ],
  },
  {
    id: 'live_viewers',
    label: 'Live',
    description: 'Attire plus de viewers sur ton concert live',
    icon: 'radio',
    gradient: ['#EF4444', '#F97316'],
    contentType: 'live',
    targetLabel: 'Choisir un concert live',
    tiers: [
      { id: 'lv1', label: 'Starter', quantity: '100 impressions',  quantity_num: 100,  duration: '1 jour',  duration_days: 1, coins: 300 },
      { id: 'lv2', label: 'Growth',  quantity: '500 impressions',  quantity_num: 500,  duration: '2 jours', duration_days: 2, coins: 800,  popular: true },
      { id: 'lv3', label: 'Viral',   quantity: '2K impressions',   quantity_num: 2000, duration: '3 jours', duration_days: 3, coins: 2000 },
      { id: 'lv4', label: 'Mega',    quantity: '8K impressions',   quantity_num: 8000, duration: '7 jours', duration_days: 7, coins: 6000 },
    ],
  },
  {
    id: 'content_reach',
    label: 'Portee',
    description: 'Booste la portee globale de ton contenu dans les feeds',
    icon: 'trending-up',
    gradient: ['#06B6D4', '#3B82F6'],
    tiers: [
      { id: 'c1', label: 'Starter', quantity: '1K impressions',   quantity_num: 1000,   duration: '3 jours',  duration_days: 3,  coins: 250 },
      { id: 'c2', label: 'Growth',  quantity: '5K impressions',   quantity_num: 5000,   duration: '7 jours',  duration_days: 7,  coins: 700,  popular: true },
      { id: 'c3', label: 'Viral',   quantity: '20K impressions',  quantity_num: 20000,  duration: '14 jours', duration_days: 14, coins: 2000 },
      { id: 'c4', label: 'Mega',    quantity: '100K impressions', quantity_num: 100000, duration: '30 jours', duration_days: 30, coins: 7000 },
    ],
  },
];
...
function computeCustomCoins(catId: string, reach: number, days: number): number {
  ...
  return Math.max(50, Math.round(reach * days * rate));
}
      ...
      >
        ...
        <View style={abc.mainRow}>
          ...
          <View style={{ alignItems: 'center', gap: 4, marginLeft: 8 }}>
            ...
            {boost.status === 'active' && (
              <Text style={[abc.daysLeft, { color: colors.textTertiary }]}>
                {dl}j
              </Text>
            )}
          </View>
...
const ContentPicker: React.FC<{
  ...
  colors: any;
}> = ({ contentType, targetLabel, g1, selected, onSelect, colors }) => {
  ...
  const V1 = '/api/v1';
  const urlFor = useCallback((q: string) => {
    if (contentType === 'reel')    return `${V1}/reels?search=${encodeURIComponent(q)}&limit=20`;
    if (contentType === 'post')    return `${V1}/posts/feed?limit=20`;
    if (contentType === 'event')   return `${V1}/events?search=${encodeURIComponent(q)}&limit=20`;
    if (contentType === 'concert') return `${V1}/concerts?search=${encodeURIComponent(q)}&limit=20`;
    if (contentType === 'live')    return `${V1}/concerts/live?limit=20`;
    return `${V1}/reels?limit=20`;
  }, [contentType]);

  function normalize(item: any): TargetContent {
    if (contentType === 'reel')    return { id: item.id, title: item.title ?? item.description ?? 'Reel', thumbnail: item.thumbnail_url };
    if (contentType === 'post')    return { id: item.id, title: (item.body ?? item.feeling ?? 'Post').slice(0, 80) };
    if (contentType === 'event')   return { id: item.id, title: item.title ?? item.name ?? 'Evenement', thumbnail: item.thumbnail_url };
    if (contentType === 'concert') return { id: item.id, title: item.title ?? item.artist_name ?? 'Concert', thumbnail: item.thumbnail_url };
    if (contentType === 'live')    return { id: item.id, title: item.title ?? 'Live', thumbnail: item.thumbnail_url };
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(async () => {
      setLoading(true);
      try {
        const res = await apiClient.get<any>(urlFor(query));
      ...
      >
        {selected ? (
          <>
            ...
            <Text style={[cp.triggerText, { color: g1, flex: 1 }]} numberOfLines={1}>{selected.title}</Text>
        ...
        <View style={[cp.modal, { backgroundColor: colors.background }]}>
          <View style={[cp.header, { borderBottomColor: colors.border }]}>
            ...
            <TextInput
              ...
              placeholder={`Rechercher un ${contentType}...`}
...
export default function BoostScreen() {
  ...
  function handleSelectCustom() {
    ...
    setSelectedTier({
      ...
      quantity: `${fmtNum(customReach)} impressions`, quantity_num: customReach,
            ...
            <View style={[s.customPanel, { backgroundColor: colors.surface, borderColor: g1 + '25' }]}>
              <View>
                <View style={s.customLabelRow}>
                  ...
                  <Text style={[s.customValue, { color: g1 }]}>{fmtNum(customReach)} impressions</Text>
                </View>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 6, marginBottom: 10 }}>
                  {[500, 1000, 5000, 10000, 50000].map(p => (
                    <TouchableOpacity
                      key={p}
              ...
              <View style={[s.customSummary, { backgroundColor: g1 + '10', borderColor: g1 + '20' }]}>
                <View>
                  <Text style={{ fontSize: 13, fontWeight: '700', color: colors.textPrimary }}>
                    {fmtNum(customReach)} impressions · {customDays}j
                  </Text>
...
const s = StyleSheet.create({
  ...
  descBox:       { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 16, borderWidth: 1, padding: 14 },
  descIcon:      { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  descTitle:     { fontSize: 14, fontWeight: '800', marginBottom: 2 },
