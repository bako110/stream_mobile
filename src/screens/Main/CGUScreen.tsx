...
const SECTIONS: Section[] = [
  {
    ...
    body: `Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de la plateforme GoFolix (application mobile et site web), éditée par GoFolix SAS, société par actions simplifiée au capital de 10 000 €, immatriculée au RCS de Paris.
...
Si vous pensez qu'un contenu publié sur GoFolix porte atteinte à vos droits d'auteur, contactez notre équipe de signalement à : dmca@gofolix.app`,
  },
  {
...
• Nous vous encourageons à nous contacter d'abord à l'adresse legal@gofolix.app pour tenter une résolution amiable
...
Pour toute question légale : legal@gofolix.app`,
  },
];
    ...
    <View style={[s.root, { backgroundColor: colors.background }]}>
      ...
      <ScrollView ref={scrollRef} showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        <View style={[s.introBanner, { backgroundColor: colors.primary + '12', borderColor: colors.primary + '30' }]}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={[s.introTitle, { color: colors.textPrimary }]}>CGU GoFolix</Text>
            ...
            <Text style={[s.introDesc, { color: colors.textSecondary }]}>
              Ces conditions régissent votre utilisation de la plateforme GoFolix. Lisez-les attentivement.
            </Text>
          </View>
        </View>
        ...
        <View style={[s.contactCard, { backgroundColor: colors.surface, borderColor: colors.divider }]}>
          ...
          <Text style={[s.contactTxt, { color: colors.textTertiary }]}>
            ...
            <Text style={{ color: colors.primary, fontWeight: '600' }}>legal@gofolix.app</Text>
          </Text>
        </View>
