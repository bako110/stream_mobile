...
const SECTIONS: Section[] = [
  {
    ...
    body: `Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de la plateforme FoliX (application mobile et site web), éditée par FoliX SAS, société par actions simplifiée au capital de 10 000 €, immatriculée au RCS de Paris.
...
Si vous pensez qu'un contenu publié sur FoliX porte atteinte à vos droits d'auteur, contactez notre équipe de signalement à : dmca@folix.app`,
  },
  {
...
• Nous vous encourageons à nous contacter d'abord à l'adresse legal@folix.app pour tenter une résolution amiable
...
Pour toute question légale : legal@folix.app`,
  },
];
    ...
    <View style={[s.root, { backgroundColor: colors.background }]}>
      ...
      <ScrollView ref={scrollRef} showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        <View style={[s.introBanner, { backgroundColor: colors.primary + '12', borderColor: colors.primary + '30' }]}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={[s.introTitle, { color: colors.textPrimary }]}>CGU FoliX</Text>
            ...
            <Text style={[s.introDesc, { color: colors.textSecondary }]}>
              Ces conditions régissent votre utilisation de la plateforme FoliX. Lisez-les attentivement.
            </Text>
          </View>
        </View>
